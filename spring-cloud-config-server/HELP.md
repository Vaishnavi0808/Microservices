...
* The original package name 'com.vaishnavi.microservices.spring-cloud-config-server' is invalid and this project uses 'com.vaishnavi.microservices.springcloudconfigserver' instead.
